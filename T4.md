...
0. Evolución JS
  ...
  10. Uso librerias externas: chart.js
...
#### Ejemplo 11: Crear nueva ventana en Navegador con un documento
...
- **listener** El objeto que recibe una notificación cuando el evento especificado ocurre. Debe ser un objeto implementando la interfaz EventListener o solo una function JavaScript. Puede ser nulo. 
...
### Ejercicio 2: 
Refactorizar el  Ejemplo 10 con eventhandlers y window.DOMContentLoaded_event(DHTML).

### ¿Cuestión DOMContentLoaded o Load ¿Cual es mejor?
