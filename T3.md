...
#### Ejercicio: ?Que errores hay en este código?
...
```
### Ejercicio: ?Que mostraria este código?
```PHP
<?php
print $_REQUEST["pais"];
print $_REQUEST["name"];
...
?>
```
[demo](https://piruletas3.000webhostapp.com/PHP/ejTeo/T2/cookiesE.php)
##### Cuestión:
...
?>
```
[demo](https://piruletas3.000webhostapp.com/PHP/ejTeo/T2/session0.php)
...
<img src="./media/T2/ResourceShow.jpeg">
